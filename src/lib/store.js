(function () {
  ...
  function tableHandlerFor(name) {
    switch (name) {
        ...
        return {
          ...
          toRow(record, existing) {
            ...
            return compactObject({
              ...
              first_phase_choice: valueOf(input, 'firstPhaseChoice', 'first_phase_choice') ?? null,
              second_phase_choice: valueOf(input, 'secondPhaseChoice', 'second_phase_choice') ?? null,
              final_exit_phase: valueOf(input, 'finalExitPhase', 'final_exit_phase') ?? null,
              first_phase_prompt_at_ms: normalizeTimestamp(valueOf(input, 'firstPhasePromptAtMs', 'first_phase_prompt_at_ms')),
              second_phase_started_at_ms: normalizeTimestamp(valueOf(input, 'secondPhaseStartedAtMs', 'second_phase_started_at_ms')),
              second_phase_prompt_at_ms: normalizeTimestamp(valueOf(input, 'secondPhasePromptAtMs', 'second_phase_prompt_at_ms')),
              questionnaire_reminder_shown_at_ms: normalizeTimestamp(valueOf(input, 'questionnaireReminderShownAtMs', 'questionnaire_reminder_shown_at_ms')),
              questionnaire_returned_at_ms: normalizeTimestamp(valueOf(input, 'questionnaireReturnedAtMs', 'questionnaire_returned_at_ms')),
              first_phase_watch_ms: normalizeTimestamp(valueOf(input, 'firstPhaseWatchMs', 'first_phase_watch_ms')),
              second_phase_watch_ms: normalizeTimestamp(valueOf(input, 'secondPhaseWatchMs', 'second_phase_watch_ms')),
              questionnaire_reminder_count: normalizeNumber(valueOf(input, 'questionnaireReminderCount', 'questionnaire_reminder_count')),
              questionnaire_return_count: normalizeNumber(valueOf(input, 'questionnaireReturnCount', 'questionnaire_return_count')),
              second_phase_manual_exit_count: normalizeNumber(valueOf(input, 'secondPhaseManualExitCount', 'second_phase_manual_exit_count')),
              ...
              nominal_saturation_percent: normalizeNumber(valueOf(input, 'nominalSaturationPercent', 'nominal_saturation_percent')),
              nominal_apply_at_sec: normalizeNumber(valueOf(input, 'nominalApplyAtSec', 'nominal_apply_at_sec')),
              visual_treatment_applied: normalizeNumber(valueOf(input, 'visualTreatmentApplied', 'visual_treatment_applied')),
              visual_applied_at_ms: normalizeTimestamp(valueOf(input, 'visualAppliedAtMs', 'visual_applied_at_ms')),
              exit_feedback_mode: valueOf(input, 'exitFeedbackMode', 'exit_feedback_mode') ?? null,
              continue_mode: valueOf(input, 'continueMode', 'continue_mode') ?? null,
              exit_mode: valueOf(input, 'exitMode', 'exit_mode') ?? null,
              first_prompt_sec: normalizeNumber(valueOf(input, 'firstPromptSec', 'first_prompt_sec')),
              final_duration_sec: normalizeNumber(valueOf(input, 'finalDurationSec', 'final_duration_sec')),
              blocked_exit_attempt_count: normalizeNumber(valueOf(input, 'blockedExitAttemptCount', 'blocked_exit_attempt_count')),
              created_at: normalizeTimestamp(valueOf(input, 'createdAt', 'created_at') ?? valueOf(existing || {}, 'createdAt', 'created_at') ?? now),
              updated_at: normalizeTimestamp(valueOf(input, 'updatedAt', 'updated_at') ?? now),
            });
          },
          fromRow(row) {
            ...
            const record = {
              ...
              first_phase_choice: valueOf(row, 'first_phase_choice') ?? '',
              second_phase_choice: valueOf(row, 'second_phase_choice') ?? '',
              final_exit_phase: valueOf(row, 'final_exit_phase') ?? '',
              first_phase_prompt_at_ms: normalizeTimestamp(row.first_phase_prompt_at_ms),
              second_phase_started_at_ms: normalizeTimestamp(row.second_phase_started_at_ms),
              second_phase_prompt_at_ms: normalizeTimestamp(row.second_phase_prompt_at_ms),
              questionnaire_reminder_shown_at_ms: normalizeTimestamp(row.questionnaire_reminder_shown_at_ms),
              questionnaire_returned_at_ms: normalizeTimestamp(row.questionnaire_returned_at_ms),
              first_phase_watch_ms: normalizeTimestamp(row.first_phase_watch_ms),
              second_phase_watch_ms: normalizeTimestamp(row.second_phase_watch_ms),
              questionnaire_reminder_count: normalizeNumber(row.questionnaire_reminder_count),
              questionnaire_return_count: normalizeNumber(row.questionnaire_return_count),
              second_phase_manual_exit_count: normalizeNumber(row.second_phase_manual_exit_count),
              ...
              nominal_saturation_percent: normalizeNumber(row.nominal_saturation_percent),
              nominal_apply_at_sec: normalizeNumber(row.nominal_apply_at_sec),
              visual_treatment_applied: normalizeNumber(row.visual_treatment_applied),
              visual_applied_at_ms: normalizeTimestamp(row.visual_applied_at_ms),
              exit_feedback_mode: valueOf(row, 'exit_feedback_mode') ?? '',
              continue_mode: valueOf(row, 'continue_mode') ?? '',
              exit_mode: valueOf(row, 'exit_mode') ?? '',
              first_prompt_sec: normalizeNumber(row.first_prompt_sec),
              final_duration_sec: normalizeNumber(row.final_duration_sec),
              blocked_exit_attempt_count: normalizeNumber(row.blocked_exit_attempt_count),
              createdAt: normalizeTimestamp(row.created_at),
              created_at: normalizeTimestamp(row.created_at),
              updatedAt: normalizeTimestamp(row.updated_at),
              updated_at: normalizeTimestamp(row.updated_at),
      ...
      case 'feed_exit_decisions':
        return {
          prefix: 'exit',
          toRow(record, existing) {
            const input = stripInternalFields(record);
            const now = Date.now();
            const id = String(valueOf(input, 'id') || makeId('exit'));
            return compactObject({
              id,
              ...
              study: valueOf(input, 'study') ?? null,
              condition: valueOf(input, 'condition') ?? null,
              prompt_index: normalizeNumber(valueOf(input, 'promptIndex', 'prompt_index')),
              phase: valueOf(input, 'phase') ?? null,
              reason: valueOf(input, 'reason') ?? null,
              opened_at_ms: normalizeTimestamp(valueOf(input, 'openedAtMs', 'opened_at_ms')),
              opened_epoch_ms: normalizeTimestamp(valueOf(input, 'openedEpochMs', 'opened_epoch_ms')),
              choice: valueOf(input, 'choice') ?? null,
              decided_at_ms: normalizeTimestamp(valueOf(input, 'decidedAtMs', 'decided_at_ms')),
              decided_epoch_ms: normalizeTimestamp(valueOf(input, 'decidedEpochMs', 'decided_epoch_ms')),
              decision_latency_ms: normalizeTimestamp(valueOf(input, 'decisionLatencyMs', 'decision_latency_ms')),
              questionnaire_reminder_shown: normalizeBoolean(valueOf(input, 'questionnaireReminderShown', 'questionnaire_reminder_shown')),
              questionnaire_returned: normalizeBoolean(valueOf(input, 'questionnaireReturned', 'questionnaire_returned')),
              questionnaire_returned_at_ms: normalizeTimestamp(valueOf(input, 'questionnaireReturnedAtMs', 'questionnaire_returned_at_ms') ?? valueOf(existing || {}, 'questionnaireReturnedAtMs', 'questionnaire_returned_at_ms')),
              questionnaire_returned_epoch_ms: normalizeTimestamp(valueOf(input, 'questionnaireReturnedEpochMs', 'questionnaire_returned_epoch_ms') ?? valueOf(existing || {}, 'questionnaireReturnedEpochMs', 'questionnaire_returned_epoch_ms')),
              created_at: normalizeTimestamp(valueOf(input, 'createdAt', 'created_at') ?? valueOf(existing || {}, 'createdAt', 'created_at') ?? now),
              updated_at: normalizeTimestamp(valueOf(input, 'updatedAt', 'updated_at') ?? now),
            });
          },
          fromRow(row) {
            ...
            return {
              ...
              study: valueOf(row, 'study') ?? '',
              condition: valueOf(row, 'condition') ?? '',
              promptIndex: normalizeNumber(row.prompt_index),
              phase: valueOf(row, 'phase') ?? '',
              reason: valueOf(row, 'reason') ?? '',
              openedAtMs: normalizeTimestamp(row.opened_at_ms),
              openedEpochMs: normalizeTimestamp(row.opened_epoch_ms),
              choice: valueOf(row, 'choice') ?? '',
              decidedAtMs: normalizeTimestamp(row.decided_at_ms),
              decidedEpochMs: normalizeTimestamp(row.decided_epoch_ms),
              decisionLatencyMs: normalizeTimestamp(row.decision_latency_ms),
              questionnaireReminderShown: normalizeBoolean(row.questionnaire_reminder_shown),
              questionnaireReturned: normalizeBoolean(row.questionnaire_returned),
              questionnaireReturnedAtMs: normalizeTimestamp(row.questionnaire_returned_at_ms),
              questionnaire_returned_at_ms: normalizeTimestamp(row.questionnaire_returned_at_ms),
              questionnaireReturnedEpochMs: normalizeTimestamp(row.questionnaire_returned_epoch_ms),
              questionnaire_returned_epoch_ms: normalizeTimestamp(row.questionnaire_returned_epoch_ms),
              createdAt: normalizeTimestamp(row.created_at),
              updatedAt: normalizeTimestamp(row.updated_at),
            };
          },
        };
      case 'tracking_participants':
        return {
          prefix: 'participant',
          toRow(record, existing) {
            const input = stripInternalFields(record);
            const now = Date.now();
            const id = String(valueOf(input, 'id', 'participantId', 'participant_id') || makeId('participant'));
            return compactObject({
              id,
              participant_name: valueOf(input, 'participantName', 'participant_name') ?? valueOf(existing || {}, 'participantName', 'participant_name') ?? null,
              tracking_code: valueOf(input, 'trackingCode', 'tracking_code') ?? valueOf(existing || {}, 'trackingCode', 'tracking_code') ?? null,
              source: valueOf(input, 'source') ?? valueOf(existing || {}, 'source') ?? null,
              study: valueOf(input, 'study') ?? valueOf(existing || {}, 'study') ?? null,
              condition: valueOf(input, 'condition') ?? valueOf(existing || {}, 'condition') ?? null,
          ...
          fromRow(row) {
            ...
            return {
              ...
              participant_id: String(valueOf(row, 'id') || ''),
              participantName: valueOf(row, 'participant_name') ?? '',
              participant_name: valueOf(row, 'participant_name') ?? '',
              trackingCode: valueOf(row, 'tracking_code') ?? '',
              tracking_code: valueOf(row, 'tracking_code') ?? '',
              source: valueOf(row, 'source') ?? '',
              study: valueOf(row, 'study') ?? '',
              condition: valueOf(row, 'condition') ?? '',
              startDate: valueOf(row, 'start_date') ?? '',
              ...
              finalCompletedAt: normalizeTimestamp(row.final_completed_at),
              final_completed_at: normalizeTimestamp(row.final_completed_at),
              createdAt: normalizeTimestamp(row.created_at),
              created_at: normalizeTimestamp(row.created_at),
              updatedAt: normalizeTimestamp(row.updated_at),
              updated_at: normalizeTimestamp(row.updated_at),
      ...
      case 'tracking_runs':
        return {
          ...
          toRow(record, existing) {
            const input = stripInternalFields(record);
            const now = Date.now();
            const id = String(valueOf(input, 'id') || makeId('run'));
            return compactObject({
              id,
              participant_id: valueOf(input, 'participantId', 'participant_id') ?? valueOf(existing || {}, 'participantId', 'participant_id') ?? null,
              session_id: valueOf(input, 'sessionId', 'session_id') ?? valueOf(existing || {}, 'sessionId', 'session_id') ?? null,
              participant_name: valueOf(input, 'participantName', 'participant_name') ?? null,
              study: valueOf(input, 'study') ?? null,
              condition: valueOf(input, 'condition') ?? null,
              tracking_day: normalizeNumber(valueOf(input, 'trackingDay', 'tracking_day')),
              session_slot: valueOf(input, 'sessionSlot', 'session_slot') ?? null,
              target_date: valueOf(input, 'targetDate', 'target_date') ?? null,
              target_time: valueOf(input, 'targetTime', 'target_time') ?? null,
              status: valueOf(input, 'status') ?? 'started',
              late_after_slot: normalizeBoolean(valueOf(input, 'lateAfterSlot', 'late_after_slot')),
              started_at: normalizeTimestamp(valueOf(input, 'startedAt', 'started_at')),
              completed_at: normalizeTimestamp(valueOf(input, 'completedAt', 'completed_at')),
              task_completion_code: valueOf(input, 'taskCompletionCode', 'task_completion_code') ?? null,
              summary_id: valueOf(input, 'summaryId', 'summary_id') ?? null,
              created_at: normalizeTimestamp(valueOf(input, 'createdAt', 'created_at') ?? valueOf(existing || {}, 'createdAt', 'created_at') ?? now),
              updated_at: normalizeTimestamp(valueOf(input, 'updatedAt', 'updated_at') ?? now),
            });
          },
          fromRow(row) {
            return {
              id: String(valueOf(row, 'id') || ''),
              participantId: valueOf(row, 'participant_id') ?? '',
              participant_id: valueOf(row, 'participant_id') ?? '',
              sessionId: valueOf(row, 'session_id') ?? '',
              session_id: valueOf(row, 'session_id') ?? '',
              participantName: valueOf(row, 'participant_name') ?? '',
              participant_name: valueOf(row, 'participant_name') ?? '',
              study: valueOf(row, 'study') ?? '',
              condition: valueOf(row, 'condition') ?? '',
              trackingDay: normalizeNumber(row.tracking_day),
              tracking_day: normalizeNumber(row.tracking_day),
              sessionSlot: valueOf(row, 'session_slot') ?? '',
              session_slot: valueOf(row, 'session_slot') ?? '',
              targetDate: valueOf(row, 'target_date') ?? '',
              target_date: valueOf(row, 'target_date') ?? '',
              targetTime: valueOf(row, 'target_time') ?? '',
              target_time: valueOf(row, 'target_time') ?? '',
              status: valueOf(row, 'status') ?? '',
              lateAfterSlot: normalizeBoolean(row.late_after_slot),
              late_after_slot: normalizeBoolean(row.late_after_slot),
              startedAt: normalizeTimestamp(row.started_at),
              started_at: normalizeTimestamp(row.started_at),
              completedAt: normalizeTimestamp(row.completed_at),
              completed_at: normalizeTimestamp(row.completed_at),
              taskCompletionCode: valueOf(row, 'task_completion_code') ?? '',
              task_completion_code: valueOf(row, 'task_completion_code') ?? '',
              summaryId: valueOf(row, 'summary_id') ?? '',
              summary_id: valueOf(row, 'summary_id') ?? '',
              createdAt: normalizeTimestamp(row.created_at),
              created_at: normalizeTimestamp(row.created_at),
              updatedAt: normalizeTimestamp(row.updated_at),
              updated_at: normalizeTimestamp(row.updated_at),
      ...
      case 'tracking_questionnaires':
        return {
          prefix: 'questionnaire',
          toRow(record, existing) {
            const input = stripInternalFields(record);
            const now = Date.now();
            const id = String(valueOf(input, 'id') || makeId('questionnaire'));
            return compactObject({
              id,
              participant_id: valueOf(input, 'participantId', 'participant_id') ?? null,
              participant_name: valueOf(input, 'participantName', 'participant_name') ?? null,
              study: valueOf(input, 'study') ?? null,
              condition: valueOf(input, 'condition') ?? null,
              tracking_day: normalizeNumber(valueOf(input, 'trackingDay', 'tracking_day')),
              completed: normalizeBoolean(valueOf(input, 'completed')),
              questionnaire_version: valueOf(input, 'questionnaireVersion', 'questionnaire_version') ?? null,
              external_record_id: valueOf(input, 'externalRecordId', 'external_record_id') ?? null,
              completed_at: normalizeTimestamp(valueOf(input, 'completedAt', 'completed_at')),
              registered_at: normalizeTimestamp(valueOf(input, 'registeredAt', 'registered_at') ?? valueOf(existing || {}, 'registeredAt', 'registered_at') ?? now),
              notes: valueOf(input, 'notes') ?? null,
              created_at: normalizeTimestamp(valueOf(input, 'createdAt', 'created_at') ?? valueOf(existing || {}, 'createdAt', 'created_at') ?? now),
              updated_at: normalizeTimestamp(valueOf(input, 'updatedAt', 'updated_at') ?? now),
            });
          },
          fromRow(row) {
            return {
              ...
              questionnaireVersion: valueOf(row, 'questionnaire_version') ?? '',
              questionnaire_version: valueOf(row, 'questionnaire_version') ?? '',
              externalRecordId: valueOf(row, 'external_record_id') ?? '',
              external_record_id: valueOf(row, 'external_record_id') ?? '',
              completedAt: normalizeTimestamp(row.completed_at),
              completed_at: normalizeTimestamp(row.completed_at),
              registeredAt: normalizeTimestamp(row.registered_at),
              registered_at: normalizeTimestamp(row.registered_at),
              notes: valueOf(row, 'notes') ?? '',
              createdAt: normalizeTimestamp(row.created_at),
              created_at: normalizeTimestamp(row.created_at),
              updatedAt: normalizeTimestamp(row.updated_at),
              updated_at: normalizeTimestamp(row.updated_at),
      ...
      case 'tracking_followups':
        return {
          prefix: 'followup',
          toRow(record, existing) {
            const input = stripInternalFields(record);
            const now = Date.now();
            const id = String(valueOf(input, 'id') || makeId('followup'));
            return compactObject({
              id,
              participant_id: valueOf(input, 'participantId', 'participant_id') ?? null,
              participant_name: valueOf(input, 'participantName', 'participant_name') ?? null,
              ...
              status: valueOf(input, 'status') ?? 'pending',
              contacted_at: normalizeTimestamp(valueOf(input, 'contactedAt', 'contacted_at')),
              notes: valueOf(input, 'notes') ?? null,
              created_at: normalizeTimestamp(valueOf(input, 'createdAt', 'created_at') ?? valueOf(existing || {}, 'createdAt', 'created_at') ?? now),
              updated_at: normalizeTimestamp(valueOf(input, 'updatedAt', 'updated_at') ?? now),
            });
          ...
          fromRow(row) {
            return {
              ...
              contacted_at: normalizeTimestamp(row.contacted_at),
              notes: valueOf(row, 'notes') ?? '',
              createdAt: normalizeTimestamp(row.created_at),
              created_at: normalizeTimestamp(row.created_at),
              updatedAt: normalizeTimestamp(row.updated_at),
  ...
  async function exportCsv() {
    ...
    const columns = [
      ...
      'second_phase_choice',
      'final_exit_phase',
      'first_phase_prompt_at_ms',
      'second_phase_started_at_ms',
      'second_phase_prompt_at_ms',
      'questionnaire_reminder_shown_at_ms',
      'questionnaire_returned_at_ms',
      'first_phase_watch_ms',
      'second_phase_watch_ms',
      'questionnaire_reminder_count',
      'questionnaire_return_count',
      'second_phase_manual_exit_count',
      'start_epoch_ms',
      'exit_epoch_ms',
      'total_feed_ms',
      'total_dwell_ms',
      ...
      'dwell_ms_per_slide',
      'event_count',
      'nominal_saturation_percent',
      'nominal_apply_at_sec',
      'visual_treatment_applied',
      'visual_applied_at_ms',
      'exit_feedback_mode',
      'continue_mode',
      'exit_mode',
      'first_prompt_sec',
      'final_duration_sec',
      'blocked_exit_attempt_count',
      'completed',
      'completionCode',
      'redirectedAt',
      'createdAt',
    ...
    orderedIds.forEach((sessionId) => {
      ...
      const row = {
        ...
        first_phase_choice: summary.first_phase_choice ?? '',
        second_phase_choice: summary.second_phase_choice ?? '',
        final_exit_phase: summary.final_exit_phase ?? '',
        first_phase_prompt_at_ms: summary.first_phase_prompt_at_ms ?? '',
        second_phase_started_at_ms: summary.second_phase_started_at_ms ?? '',
        second_phase_prompt_at_ms: summary.second_phase_prompt_at_ms ?? '',
        questionnaire_reminder_shown_at_ms: summary.questionnaire_reminder_shown_at_ms ?? '',
        questionnaire_returned_at_ms: summary.questionnaire_returned_at_ms ?? '',
        first_phase_watch_ms: summary.first_phase_watch_ms ?? '',
        second_phase_watch_ms: summary.second_phase_watch_ms ?? '',
        questionnaire_reminder_count: summary.questionnaire_reminder_count ?? '',
        questionnaire_return_count: summary.questionnaire_return_count ?? '',
        second_phase_manual_exit_count: summary.second_phase_manual_exit_count ?? '',
        ...
        nominal_saturation_percent: summary.nominal_saturation_percent ?? '',
        nominal_apply_at_sec: summary.nominal_apply_at_sec ?? '',
        visual_treatment_applied: summary.visual_treatment_applied ?? '',
        visual_applied_at_ms: summary.visual_applied_at_ms ?? '',
        exit_feedback_mode: summary.exit_feedback_mode ?? '',
        continue_mode: summary.continue_mode ?? '',
        exit_mode: summary.exit_mode ?? '',
        first_prompt_sec: summary.first_prompt_sec ?? '',
        final_duration_sec: summary.final_duration_sec ?? '',
        blocked_exit_attempt_count: summary.blocked_exit_attempt_count ?? '',
