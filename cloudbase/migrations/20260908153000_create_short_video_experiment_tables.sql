-- CloudBase PostgreSQL schema for short-video experiment platform
--
-- This migration keeps the browser-facing table names used by src/lib/store.js.
-- It is intentionally conservative: if an existing table has incompatible columns,
-- inspect and reconcile it before applying this file in a persistent environment.
